<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="chitiet.aspx.cs" Inherits="QLBANHANG.chitiet" %>
     ...
     <asp:DataList ID="DataList1" runat="server">
        <ItemTemplate>
            <table style="width:100%;">
                <tr>
                    <td rowspan="6">
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/images/"+ Eval("HINHANH") %>' Width="50%" />
                    </td>
                    <td>
